...
class DepartmentAdmin(admin.ModelAdmin):
    ...
    list_display = ('dept_num', 'dept_name', 'created', 'updated')


@admin.register(models.DepartmentStaff)
...
@admin.register(models.DepartmentManager)
...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    list_display = ('emp_num', 'first_name', 'last_name', 'hire_date')
